...
export const Home = () => {
  ...
  const techStack = [
    ...
    { name: "VSAM", icon: FaServer },
    { name: "Windows", icon: FaWindows },
    { name: "IBM Z/OS", icon: FaServer }
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>Mainframe Developer</span>
        <Sparkle className="w-6 h-6" />
      </motion.div>

      <RGBName name="Gaurav Kumar" />
      ...
      >
        Optimizing and modernizing enterprise-level mainframe applications for efficiency and reliability.
      </motion.p>
